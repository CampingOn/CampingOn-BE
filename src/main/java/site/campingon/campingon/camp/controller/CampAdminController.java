...
public class CampAdminController {
    ...
    public ResponseEntity<CampDetailResponseDto> createCamp(
            @RequestBody @Valid CreateCampDetailRequestDto createCampDetailRequestDto) {
        Camp camp = campMapper.toCampEntity(createCampDetailRequestDto); // 요청 DTO -> 엔티티 변환
    ...
    public ResponseEntity<CampDetailResponseDto> updateCamp(
            ...
            @RequestBody @Valid UpdateCampDetailRequestDto updateCampDetailRequestDto
    ) {
        Camp updatedCamp = campMapper.toCampEntity(updateCampDetailRequestDto); // 요청 DTO -> 엔티티 변환
